...
class ProfileActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val emergencyContact1 = findViewById<EditText>(R.id.emergencyContact1)
        emergencyContact1.setText(sharedPreferences.getString("em1",null))
        val emergencyContact2 = findViewById<EditText>(R.id.emergencyContact2)
        emergencyContact1.setText(sharedPreferences.getString("em2",null))
